...
public class MarkdownTablePrinter implements TablePrinter {
    ...
    public Collection<String> printTable(Table table, ColumnAlignment... alignments) {
        ...
        for (String columnName : table.getColumnNames()) {
            ...
            String columnDelimiter = appendAlignment(COLUMN_NAME_DELIMITER.repeat(maxLengthForCurrentColumn - alCount), alignment);
    ...
    private void appendContentToRow(String value, int maxLength, StringBuilder row) {
        ...
        row.append(COLUMN_DELIMITER).append(WHITESPACE).append(value).append(WHITESPACE.repeat(fillingWhitespacesCount));
    }
