...
public record Player(String name, String fullName, LocalDate birthDate, int age, double heightCm, double weightKg,
    ...
    public static Player of(String line){
        ...
        LocalDate birthDate = LocalDate.parse(tokens[BIRTH_DATE], DATE_FORMATTER);
        ...
        List<Position> positions = Arrays.stream(tokens[POSITIONS].split(POSITION_ATTRIBUTE_DELIMITER))
